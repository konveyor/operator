...
OPERATOR_BUNDLE_IMAGE="${OPERATOR_BUNDLE_IMAGE:-quay.io/konveyor/tackle2-operator-bundle:release-0.9}"
HUB_IMAGE="${HUB_IMAGE:-quay.io/konveyor/tackle2-hub:release-0.9}"
UI_IMAGE="${UI_IMAGE:-quay.io/konveyor/tackle2-ui:latest}"
UI_INGRESS_CLASS_NAME="${UI_INGRESS_CLASS_NAME:-nginx}"
ADDON_ANALYZER_IMAGE="${ADDON_ANALYZER_IMAGE:-quay.io/konveyor/tackle2-addon-analyzer:release-0.9}"
JAVA_PROVIDER_IMAGE="${JAVA_PROVIDER_IMAGE:-quay.io/konveyor/java-external-provider:release-0.9}"
C_SHARP_PROVIDER_IMAGE="${C_SHARP_PROVIDER_IMAGE:-quay.io/konveyor/c-sharp-provider:release-0.9}"
...
spec:
  ...
  provider_c_sharp_image_fqin: ${C_SHARP_PROVIDER_IMAGE}
